  ...
  <div class="card">
    <div class="card-header">
      <div class="card-title">
        <div class="row">
          <div class="col-lg-6">
            <h5>Data Work Order</h5>
          </div>
          <div class="col-lg-6">
            <div class="float-end">
              <a href="tambah/wo.php" class="btn btn-primary">
          ...
          <tbody>
            ...
            if ($data_wo == '0') {
                ...
                foreach ($data_wo as $row) {
                    $key = $row['mileage'] . '_' . $row['created_at'] . '_' . $row['registration_no'];
            ...
            <tr>
	          ...
	          <td class="text-center"><?= $first_row['mileage']; ?> Km</td>
              
              <td class="text-center">
                <a href="aksi/wo_aksi.php?aksi=delete&created_at=<?= urlencode($first_row['created_at']); ?>&registration_no=<?= urlencode($first_row['registration_no']); ?>"
                ...
                <a href="cetak_wo.php?mileage=<?= urlencode($first_row['mileage']); ?>&registration_no=<?= urlencode($first_row['registration_no']); ?>&created_at=<?= urlencode($first_row['created_at']); ?>" target="_blank" class="btn btn-sm btn-danger">
