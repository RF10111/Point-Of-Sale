...
$db = new database();
$data_sp_used = $db->tampil_sp_used();

$search_query = isset($_GET['search']) ? $_GET['search'] : '';
$data_sp_used = $db->tampil_sp_used($search_query);
...
?>
        <tr>
            ...
            <td class="text-center">
                <a href="aksi/edit_sp_used.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-warning"><i class="bx bx-edit"></i> Edit</a>
                <a href="aksi/sp_used_aksi.php?id=<?= $row['id']; ?>&aksi=delete" class="btn btn-sm btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data spare part ini?')"><i class="bx bx-trash"></i> Hapus</a>
            </td>
        </tr>
<?php
    }
