    ...
    <div class="card-header">
      <div class="card-title">
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="float-end">
              <a href="tambah/estimasi.php" class="btn btn-primary">
          ...
          <tbody class="text-center">
            ...
            if ($data_estimasi == '0') {
                ...
                foreach ($data_estimasi as $row) {
                    $key = $row['registration_no'] . '_' . $row['created_at'];
            ...
            <tr>
              ...
              <td class="text-center"><?= formatRupiah($first_row['grand_total'], 2); ?></td>
              <td class="text-center">
                <a href="aksi/estimasi_aksi.php?aksi=delete&created_at=<?= urlencode($first_row['created_at']); ?>&registration_no=<?= urlencode($first_row['registration_no']); ?>"
                  class="btn btn-sm btn-danger"
                  onclick="return confirm('Apakah Anda yakin ingin menghapus estimasi ini?')">
                  <i class="bx bx-trash"></i> Hapus
                </a>
                <button class="btn btn-sm btn-primary" onclick="showDetails('<?= $key; ?>')">Detail</button>
                <a href="cetak_estimasi.php?created_at=<?= urlencode($first_row['created_at']); ?>&registration_no=<?= urlencode($first_row['registration_no']); ?>" target="_blank" class="btn btn-sm btn-danger">
